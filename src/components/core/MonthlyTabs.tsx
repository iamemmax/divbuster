...
export const MonthlyTabs: React.FC<MonthlyTabsProps> = ({
  ...
  return (
    <div className={cn("flex border border-gray-200 w-full dark:border-gray-700 rounded-lg overflow-hidden", className)}>
      ...
      >
        {value === 'this-month' && <span className="size-2 bg-green-500 mr-2"></span>}
        {t.thisMonth}
      </Button>
      ...
      >
        {value === 'last-month' && <span className="size-2 bg-green-500 mr-2"></span>}
        {t.lastMonth}
      </Button>
      ...
      >
        {value === 'custom' ? (
          <span className="size-2 bg-green-500 mr-2"></span>
        ) : (
          <svg 
