    ...
    <DialogPortal>
      ...
      >
        <DialogPrimitive.Content
          className={cn(
            'fixed bottom-0 z-50 h-max max-h-modal-content w-full gap-4  rounded-t-[2.125rem]  animate-in data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-10 sm:static sm:bottom-auto sm:my-[5vh] sm:max-h-none sm:max-w-[28rem] sm:overflow-visible sm:rounded-[1.125rem] sm:zoom-in-90 data-[state=open]:sm:slide-in-from-bottom-0',
            className
          )}
          ref={ref}
          {...props}
