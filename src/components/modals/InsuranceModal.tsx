          ...
          <div className="p-6">
            ...
            <DialogHeader className="text-center flex flex-col mb-6">
              <DialogTitle className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                {title || "Insurance Forms Required"}
              </DialogTitle>
              <p className="text-gray-600 dark:text-gray-300 text-base leading-relaxed">
                {description || "You must complete your insurance forms before proceeding. This ensures your safety and compliance with diving regulations."}
              </p>
            </DialogHeader>
            ...
            <div className="space-y-3 mb-6">
              {!user?.has_filled_medical&&<div className="flex items-center gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                ...
                <span className="text-sm text-blue-800 dark:text-blue-200">Medical Form</span>
              </div>}
             {!user?.has_filled_liability&& <div className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <span className="text-sm text-green-800 dark:text-green-200">Liability Waiver</span>
              </div>}
            </div>
