...
// // Cache to store successful geocoding results
// const locationCache = new Map<string, string>()

// export const LocationDisplay: React.FC<LocationDisplayProps> = ({ lat, lon, fallback = "Location unavailable" }) => {
