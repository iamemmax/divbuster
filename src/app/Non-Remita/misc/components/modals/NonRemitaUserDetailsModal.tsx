...
interface UseBooleanStateControlProps {
    isNonRemitaUserDetailsModalOpen: boolean;
    setNonRemitaUserDetailsModal: React.Dispatch<
        React.SetStateAction<boolean>
    >;
    setFourthNonRemitaModal: React.Dispatch<React.SetStateAction<boolean>>;
    heading: string;
    subheading: string;
...
function NonRemitaUserDetailsModal({

    isNonRemitaUserDetailsModalOpen,
    setNonRemitaUserDetailsModal,
    setFourthNonRemitaModal,
    heading,
    subheading,
    statedroplist,
...
hospital: z
    ...
    const handleClose = () => {
        ...
        setNonRemitaUserDetailsModal(false)
        router.back();
    ...
    return (
        ...
        <div className="rounded-xl">
            ...
            <ClientOnly>
                ...
                <Dialog open={isNonRemitaUserDetailsModalOpen}
                    onOpenChange={setNonRemitaUserDetailsModal}>
...
export default NonRemitaUserDetailsModal
