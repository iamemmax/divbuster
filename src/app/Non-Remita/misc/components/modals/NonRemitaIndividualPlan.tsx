...
interface UseBooleanStateControlProps {
  isNonRemitaIndividualModalOpen: boolean;
  setNonRemitaIndividualModal: React.Dispatch<React.SetStateAction<boolean>>;
  setFifthNonRemitaModal: React.Dispatch<React.SetStateAction<boolean>>;
  heading: string;
  subheading: string;
...
function NonRemitaIndividualModal({
  isNonRemitaIndividualModalOpen,
  setNonRemitaIndividualModal,
  heading,
  subheading,
  description,
  Tab1,
  Tab2,
  setFifthNonRemitaModal,
  ...
  const handleClose = () => {
    setNonRemitaIndividualModal(false);
  ...
  return (
    <div className="">
      <ClientOnly>
        <Dialog
          open={isNonRemitaIndividualModalOpen}
          onOpenChange={setNonRemitaIndividualModal}
        >
          <DialogContent className="!overflow-hidden w-full h-[55rem]">
                            ...
                            <div className="pt-[33px] px-[17px] pb-5">
                              ...
                              <div className="mt-10">
                                {firstMonthPlan.map((item, index) => (
                                  <div
                                    key={index}
                                    className="flex gap-2  border-b-2 border-[#1A2346] mt-4 mr-[4rem]"
                                  >
                                    <svg
                                      className="z-40 mt-1"
                                      width="17 "
            ...
            shadow-lg transition-colors delay-150 ease-in-out hover:bg-slate-300 focus:outline-none text-[#1B1687]"
                    ...
                    <div className="flex sm:flex-row flex-col w-full justify-center items-center mt-[3rem] gap-1 flex-nowrap">
                      <p className="text-[#747577]">
                        Terms & Conditions Apply:
                      </p>

                      <Link href="/Individual-Plan/">
                        <p className="text-white">libertyassured.com</p>
                      </Link>
                    </div>
                  </TabsContent>
...
export default NonRemitaIndividualModal;
