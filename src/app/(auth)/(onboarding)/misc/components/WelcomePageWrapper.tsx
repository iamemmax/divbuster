...
export function WelcomePageWrapper({
  ...
  return (
    <>
      <main className="relative flex items-center justify-start  mx-auto px-6  bg-[#000D36] max-w-[32.375rem] md:h-auto md:min-h-0 md:w-full md:grow-0  md:overflow-y-auto ">

        {/* <div className="relative h-auto px-6 pb-10 pt-[5vh] md:py-16 lg:px-14 ">
          <div
            className={cn(
              'absolute inset-0 bg-[#000D36]'
            )}
          />
          <h1
            className={cn(
