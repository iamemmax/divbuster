...
interface CylinderIconProps extends SVGProps<SVGSVGElement> {
  volume: string;
  bgColor?: string;     // Background color of the cylinder (optional)
  textColor?: string;   // Color of the volume text (optional)
}

// Custom Cylinder SVG Component with TypeScript
export const CylinderIcon: React.FC<CylinderIconProps> = ({
  volume,
  bgColor = 'white',       // default fill
  textColor = '#052D86',   // default text color
  ...props
}) => (
  <svg
    width={29}
