...
import { certificationTypesTranslations } from "../../translation/certificationTranslation";
...
const CERTIFICATE_TYPE_CHOICES = [
  { value: "intro", bg: "#1E3A8A", text: "#FFFFFF" },
  { value: "try", bg: "#7F1D1D", text: "#FFFFFF" },
  { value: "snorkel", bg: "#065F46", text: "#FFFFFF" },
  { value: "free", bg: "#1F2937", text: "#FFFFFF" },
  { value: "adv_free", bg: "#4C1D95", text: "#FFFFFF" },
  { value: "master_free", bg: "#78350F", text: "#FFFFFF" },
  { value: "scuba", bg: "#0F172A", text: "#FFFFFF" },
  { value: "open", bg: "#1E40AF", text: "#FFFFFF" },
  { value: "adv_open", bg: "#4338CA", text: "#FFFFFF" },
  { value: "rescue", bg: "#9F1239", text: "#FFFFFF" },
  { value: "master", bg: "#312E81", text: "#FFFFFF" },
  { value: "fun", bg: "#064E3B", text: "#FFFFFF" },
  { value: "adv_adventurer", bg: "#581C87", text: "#FFFFFF" },
  { value: "nitrox", bg: "#064E3B", text: "#FFFFFF" },
  { value: "deep", bg: "#0C4A6E", text: "#FFFFFF" },
  { value: "wreck", bg: "#374151", text: "#FFFFFF" },
  { value: "night", bg: "#000000", text: "#FFFFFF" },
  { value: "ppb", bg: "#4A044E", text: "#FFFFFF" },
  { value: "dry", bg: "#115E59", text: "#FFFFFF" },
  { value: "search_recover", bg: "#7C2D12", text: "#FFFFFF" },
  { value: "nav", bg: "#713F12", text: "#FFFFFF" },
  { value: "photo", bg: "#831843", text: "#FFFFFF" },
  { value: "cmas1", bg: "#1E3A8A", text: "#FFFFFF" },
  { value: "cmas2", bg: "#1D4ED8", text: "#FFFFFF" },
  { value: "cmas3", bg: "#2563EB", text: "#FFFFFF" },
  { value: "tech40", bg: "#134E4A", text: "#FFFFFF" },
  { value: "tech45", bg: "#0D9488", text: "#FFFFFF" },
  { value: "tech50", bg: "#0F766E", text: "#FFFFFF" },
  { value: "sidemount", bg: "#312E81", text: "#FFFFFF" },
  { value: "trimix", bg: "#7F1D1D", text: "#FFFFFF" },
  { value: "adv_trimix", bg: "#991B1B", text: "#FFFFFF" },
  { value: "cave", bg: "#3F3F46", text: "#FFFFFF" },
  { value: "rebreather", bg: "#334155", text: "#FFFFFF" },
  { value: "dive_master", bg: "#14532D", text: "#FFFFFF" },
  { value: "assistant_instructor", bg: "#854D0E", text: "#FFFFFF" },
  { value: "instructor", bg: "#CA8A04", text: "#000000" },
  { value: "staff_instructor", bg: "#B45309", text: "#FFFFFF" },
  { value: "course_director", bg: "#9A3412", text: "#FFFFFF" },
];

const SelectCertificationType = ({
  setStep,
  setSelectedCard,
  selectedCard,
  ...
  const t = certificationTypesTranslations[language] || certificationTypesTranslations.en;
        ...
        {CERTIFICATE_TYPE_CHOICES.map((card) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between items-start">
                <p className="text-sm font-medium font-archivo">{t.certificate}</p>
                <div className="h-[2.1437rem] mt-2 flex items-center justify-center w-[2.1437rem] border border-white rounded-full">
                  <CardHeadIcon />
                </div>
              </div>
              ...
              <div>
                <p className="text-xs font-medium font-archivo">{t.issuer}:</p>
                <p className="text-lg font-semibold font-archivo">
                  {t.types[card.value as keyof typeof t.types]}
                </p>
              </div>
