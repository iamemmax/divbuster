...
const DiveActivityCard = () => {
  ...
  return (
    <div className="w-full mt-[10px] bg-white">
      {diveActivities.map((activity) => (
        <div key={activity.id} className="bg-white w-full mb-6">
          {/* User Profile Header */}
            ...
            <div className="flex items-start gap-3 w-full">
              ...
              <div className="w-full  flex-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {activity.isOnline && (
                    <div className="bg-[#ECFDF3] rounded-2xl gap-x-[.4375rem] px-[1rem] flex items-center  py-[.2188rem]">
                      <div className="w-[6px] h-[6px] rounded-full bg-[#12B76A]" />
                      <p className="text-sm font-medium font-archivo text-[#027A48]">
                        Online
                      </p>
                    </div>
                  )}
          ...
          <div className="flex items-center justify-between p-4 pt-0 mt-7">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button
                ...
                className={`transition-all duration-200 bg-[#F9FAFB] px-[18px] py-[.6563rem] w-[3.75rem] h-[2.8125rem] rounded-2xl hover:bg-red-50 ${
              ...
              <Button
                ...
                className={`transition-all duration-200 bg-[#F9FAFB] px-[18px] py-[.6563rem] w-[3.75rem] h-[2.8125rem] rounded-2xl hover:bg-blue-50 ${
              ...
              <Button
                ...
                className={`transition-all duration-200 bg-[#F9FAFB] px-[18px] py-[.6563rem] w-[3.75rem] h-[2.8125rem] rounded-2xl hover:bg-yellow-50 ${
