...
const BannerLeftContainer = () => {
  ...
  return (
    <div>
      ...
      <div className="mt-2">
        <h2 className="text-white font-verdana font-bold max-sm:text-[2rem] text-[3rem] md:text-[2.6rem] xl:leading-tight xl:text-[4.375rem] ">Unleash your <span className="text-[#4649E5]">Financial Trading</span> Possibilities.</h2>
