...
const StepSection = () => {
  ...
  return (
    <div className=" rounded-t-[9.375rem] bg-[position:center] bg-[#02010d] w-full  bg-[url('/images/homepage/map.svg')] rounded-md bg-no-repeat bg-opacity-50">
      <div className=" px-6 bg-no-repeat bg-cover h-full md:px-[2rem] pt-[4.5rem] pb-5 xl:pb-[50px] xl:px-[4.5rem]">
