...
// import { getPlan, useGetPlan } from "../../misc/components/insurance/api/plan/getPlan";
...
// import AddRemitalPhoneNumer from "../../misc/components/insurance/modals/referral/AddReferralPhoneNumber";
// import ReferralPlanPayment from "../../misc/components/insurance/modals/referral/RefeerralPayment";
...
// interface Prop{
//     showAprokoPlanModal: boolean;
//     setshowAprokoPlanModal: Dispatch<SetStateAction<boolean>>
// }
// const AprokoPlanModal = ({setshowAprokoPlanModal,showAprokoPlanModal}:Prop) => {
//   const {
//     isErrorModalOpen,
//     setErrorModalState,
...
//   const [openReferralPhonNumber, setOpenReferralPhonNumber] = useState(false);
...
//       {loadingPlan ? (
//         <div className="fixed z-[9999999999999999999] inset-0 bg-white flex justify-center items-center">
//           <Spinner color="white" />
//         </div>
//       ) : (
//         <Dialog open={showAprokoPlanModal}>
...
//                     onClick={() => setshowAprokoPlanModal(false)}
//                 >
//                   <button>Close</button>
//                 </DialogClose>
//               </DialogHeader>
...
//                                           setOpenReferralPhonNumber(true);
//                                         }}
//                                       >
//                                         Get Insurance
//                                       </Button>
...
// export default AprokoPlanModal;
