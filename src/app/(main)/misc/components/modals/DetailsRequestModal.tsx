...
interface UseBooleanStateControlProps {
    ...
    setDetailsRequestModal: React.Dispatch<
    ...
    return (
        ...
        <div className="">
            ...
            <ClientOnly>
                ...
                <Dialog open={isDetailsRequestModalOpen} 
                        ...
                        <DialogHeader className="bg-[#1B1687] ">
                            ...
                            <DialogTitle className="text-[#fff]">
                                {heading}
                                    ...
                                    {/* <DialogClose className="" onClick={()=>setDetailsRequestModal(false)}>Close</DialogClose> */}
