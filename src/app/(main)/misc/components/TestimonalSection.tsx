...
const TestimonialSection = () => {
    ...
    return (
        ...
        <section className='relative flex flex-col justify-center items-center bg-gradient-to-b from-[#1B1F33] to-main md:rounded-t-2xl px-4 py-6 sm:p-8 md:py-[4rem] lg:p-16 overflow-y-hidden'>
