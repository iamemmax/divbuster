          ...
          <DialogBody className="bg-[#151D42] w-full ">
            ...
            <div className="h-[409px] w-full  mt-10 ">
              <Tabs className="" defaultValue="Individual">
                ...
                <TabsContent
                  className="mt-1 rounded-10 w-full   py-10  lg:py-4"
                  value="Individual"
                >
                  <div className="w-full flex flex-col sm:flex-row gap-[1rem] px-6  items-center justify-center">
                            ...
                            <div className="w-full py-8 px-6">
                              ...
                              <div className="space-y-4">
                                {list?.map((list, index: number) => (
                                  <div
                                    className="flex border-b-[0.3px] border-[#fff] items-center gap-x-2"
                                    key={index}
                                  >
                                    <RemitalListIcon />
                                    <p className="text-white text-xs">{list}</p>
                                  </div>
                                ))}
                              </div>
                            </div>
