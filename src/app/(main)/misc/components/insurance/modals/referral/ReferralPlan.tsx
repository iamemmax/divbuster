...
// type PlanType = "FAMILY" | "CORPORATE";
...
//   const [corporateCount, setCorporateCount] = useState(4); // Default minimum for corporate
//   const [minFamilyCount] = useState(3); // Default minimum for family
//   const [minCorporateCount] = useState(4); // Default minimum for corporate
...
//   useEffect(() => {
//     if (healthPlan) {
//       const { package_name } = healthPlan;
//       setMinimumCount(package_name);
//     }
//   }, [healthPlan]);
...
//     plan: PlanType,
//     duration: number,
//     seletedPlan: PlanData
//   ) => {
//     // console.log(plan, seletedPlan, duration);

//     if (
//       plan === "FAMILY" &&
//       seletedPlan?.plan_duration?.duration === duration
//     ) {
//       setFamilyCount((prevCount) => prevCount + 1);
//     } else if (plan === "CORPORATE" && duration) {
//       setCorporateCount((prevCount) => prevCount + 1);
//     }
//   };

//   const decrement = (plan: PlanType) => {
//     if (plan === "FAMILY") {
//       setFamilyCount((prevCount) =>
//         prevCount > minFamilyCount ? prevCount - 1 : minFamilyCount
//       );
//     } else if (plan === "CORPORATE") {
//       setCorporateCount((prevCount) =>
//         prevCount > minCorporateCount ? prevCount - 1 : minCorporateCount
//       );
//     }
//   };

//   const setMinimumCount = (type: PlanType) => {
//     if (type === "FAMILY") {
//       setFamilyCount((prevCount) => Math.max(prevCount, minFamilyCount));
//     } else if (type === "CORPORATE") {
//       setCorporateCount((prevCount) => Math.max(prevCount, minCorporateCount));
//     }
//   };

//   if (!healthPlan) return <div>Loading...</div>; // Optionally render a loading state
//   // Optionally render a loading state

//   //   const [totalAmount, setTotalAmount] = useState<number | null>(null);
//   //   const [discountedAmount, setDiscountedAmount] = useState<number | null>(null);

//   function getAmountDeduction(
//     basePrice: number,
//     duration: number,
...
//                                               onClick={() =>
//                                                 decrement(
//                                                   healthPlan.package_name as PlanType
//                                                 )
//                                               }
...
//                                             </p>
//                                           </div>
//                                           <div className="w-full absolute mt-12 text-red-800">
//                                             {formatCurrency(
