...
const addBooking = async ({data:{book_now,dive_event_id,dive_level,email,event_date_id,first_name,instructor_id,last_name,other_participants,lang}}:bookindProp) => {
