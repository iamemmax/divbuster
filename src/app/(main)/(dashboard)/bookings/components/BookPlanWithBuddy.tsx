...
// Main Component
const BookPlanWithBuddy: React.FC = () => {
  ...
  const handleViewPlan = (title: string): void => {
    console.log(`View plan clicked for: ${title}`);
  };
  ...
  return (
    ...
    <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
        <div className="py-4">
          ...
          <div className="flex items-center gap-y-3 flex-wrap justify-between py-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-6">
          {diveData.map((dive: DiveData, index: number) => (
            <BookingCard
              ...
              viewPlanText='View Dive Plan History'
 onReadMore={() =>{
      ...
      {showViewBookingDetailsModal &&
        ...
        <ViewBookingDivePlan isOpen={showViewBookingDivePlanModal} title='Amazing Dive Community Events Summary' type='event' setIsOpen={setShowViewBookingDivePlanModal}/>
      }
    </div>
  );
};

export default BookPlanWithBuddy;