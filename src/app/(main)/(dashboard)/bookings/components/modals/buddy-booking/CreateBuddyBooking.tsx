...
const CreateBuddyBooking = ({isOpen,setIsOpenCardModal}:Props) => {
        ...
        switch (step) {
         ...
         case 2: 
                ...
                return <CreateDivePlanBuddyBooking onClose={()=>setIsOpenCardModal(false)} setStep={setStep} setBuddyMembers={setBuddyMembers} stepOneLogDetails={stepOneLogDetails} buddyMembers={buddyMembers}/>
                       default:
                return <DiveBuddyInfo setStep={setStep}   setStepOneLogDetails={setStepOneLogDetails}    />
        }
    }
