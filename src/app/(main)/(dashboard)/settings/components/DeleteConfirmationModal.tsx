...
<g clipPath="url(#clip0_2542_38034)">
        ...
        <div className="px-6 pb-6 text-center">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              disabled={loading}
              className="flex-1 p-3 text-nowrap text-xs md:text-sm font-archivo max-xxscren:text-xxs md:px-6 border border-gray-300 text-gray-700 rounded-xl font-medium hover:bg-gray-50
            ...
            <button
              onClick={onConfirm}
              disabled={loading}
              className="flex-1 p-3 text-nowrap text-xs md:text-sm font-archivo max-xxscren:text-xxs md:px-6 bg-red-500 text-white rounded-xl font-medium hover:bg-red-600
                       transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex
