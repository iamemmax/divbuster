      ...
      <div className="mb-12">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button
            ...
            className="size-[45px] bg-orange-600 hover:bg-orange-700 rounded-full flex items-center justify-center transition-colors duration-200"
          ...
          <button
            ...
            className="size-[45px] bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 hover:from-purple-600 hover:via-pink-600 hover:to-orange-600 rounded-full flex items-center justify-center transition-all duration-200"
          ...
          {user?.profile_details?.downlines?.map((invite, index) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="size-8 rounded-full bg-orange-500 flex items-center justify-center text-white text-xs font-medium overflow-hidden">
                  {invite?.image ? (
                    <Image src={invite?.image} alt={invite.name} width={32} height={32} className="size-8 object-cover" />
                  ) : (
