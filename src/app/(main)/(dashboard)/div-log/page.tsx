...
const DiveLog = () => {
  const [globalSeaech, setGlobalSeaech] = useState("");
    ...
    <div className="text-black dark:text-white">
      ...
      <div className="mt-[2.125rem] md:px-[1.875rem] h-[83vh] overflow-y-auto">
        <div className="flex justify-between items-center flex-wrap">
          ...
          <div className="border border-[#D0D5DD] flex items-center gap-2 rounded-lg py-[.625rem] px-4 text-[#344054] text-sm font-archivo font-medium cursor-pointer dark:text-white dark:bg-black" onClick={() => setShowDatePicker(true)}>
            <svg
              width="18"
              height="20"
              viewBox="0 0 18 20"
          ...
          {stats?.map((stat, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between flex-wrap mt-2">
                ...
                <div className="">
                  {stat.count === "high" && (
                    <p className="text-xs md:text-sm bg-[#ECFDF3] gap-1 flex items-center max-w-[70px] rounded-2xl py-[.3063rem] px-[.7813rem] font-medium text-[#027A48] dark:text-green-400">
                      <UpArrow />
                      {stat.percentage}
                    </p>
                  )}
                  {stat.count === "low" && (
                    <p className="text-xs md:text-sm font-medium gap-1 flex items-center max-w-[70px]  bg-[#FEF3F2] rounded-2xl py-[.3063rem] px-[.7813rem] font-archivo text-[#B42318] dark:text-red-400">
                      <svg
                        width="10"
                        height="10"
                        viewBox="0 0 10 10"
