...
const advancedDetailsSchema = z.object({
  ...
  air_type: z.string().optional(),
  cylinder: z.string().optional(),
  weight: z.string().optional(),
  mask: z.string().optional(),
  regulator: z.string().optional(),
  additional_gears: z.string().optional(),
...
const AddAirUsage: React.FC<AdvancedDetailsModalProps> = ({
  isOpen,
  onClose,
  initialData = {},
  // onSave,
  ...
  const {
    ...
    defaultValues: {
      ...
      cylinder: initialData.cylinder || '',
      weight: initialData.weight || '',
      mask: initialData.mask || '',
      regulator: initialData.regulator || '',
      additional_gears: initialData.additional_gears || '',
    ...
    <Dialog modal={true} open={isOpen}>
      <DialogContent className="w-full !max-w-[57.3125rem] ">
       ...
       <div className=" border-gray-200 flex justify-between items-center border-b  border-opacity-55 pb-4">
          <h2 className="text-xl font-semibold font-archivo  text-[#101828]">Air Usage</h2>
              ...
              <div className='grid grid-cols-[1fr_2fr] border-b border-[#EAECF0] border-opacity-50 py-2 items-center gap-5'>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    errors.pressure ? "border-red-500" : "border-[#E2E8F0]"
...
>
              ...
              <div className='grid grid-cols-[1fr_2fr] border-b border-[#EAECF0] border-opacity-50 py-2 items-center gap-5'>
                ...
                <label className="block text-sm font-medium text-gray-700 mb-1">Air Type</label>
                <Controller
                  name="air_type"
                  control={control}
                  render={({ field }) => (
                    <Select onValueChange={field.onChange} value={field.value}>
                      <SelectTrigger className={`border relative ${
                    errors.air_type ? "border-red-500" : "border-[#E2E8F0]"
                  } outline-none py-[.8125rem] w-full text-black text-sm flex-1 bg-white font-archivo h-[48px] rounded-lg px-[.875rem] focus:border-[#F7931D] focus:ring-2 focus:ring-[#F7931D]/20 transition-colors`}
>
                        <SelectValue placeholder="Nitrox" />
                                                <div className="absolute right-4"><CaretDown color='black'/></div>
              ...
              <div className='grid grid-cols-[1fr_2fr] border-b border-[#EAECF0] border-opacity-50 py-2 items-center gap-5'>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select onValueChange={field.onChange} value={field.value}>
                      <SelectTrigger className={`border relative ${
                    errors.cylinder ? "border-red-500" : "border-[#E2E8F0]"
                  } outline-none py-[.8125rem] w-full text-black text-sm flex-1 bg-white font-archivo h-[48px] rounded-lg px-[.875rem] focus:border-[#F7931D] focus:ring-2 focus:ring-[#F7931D]/20 transition-colors`}
>
                        <SelectValue placeholder="Nitrox" />
                                                <div className="absolute right-4"><CaretDown color='black'/></div>
...
>
                ...
                <label className="block text-sm font-medium text-gray-700 mb-1">Additional Gears</label>
                <Controller
                  name="additional_gears"
                  control={control}
                  render={({ field }) => (
                    <Select onValueChange={field.onChange} value={field.value}>
                      <SelectTrigger className={`border relative ${
                    errors.additional_gears ? "border-red-500" : "border-[#E2E8F0]"
                  } outline-none py-[.8125rem] w-full text-black text-sm flex-1 bg-white font-archivo h-[48px] rounded-lg px-[.875rem] focus:border-[#F7931D] focus:ring-2 focus:ring-[#F7931D]/20 transition-colors`}
>
                        <SelectValue placeholder="Nitrox" />
                                                <div className="absolute right-4"><CaretDown color='black'/></div>
