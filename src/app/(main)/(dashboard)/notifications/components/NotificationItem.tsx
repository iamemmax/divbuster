          ...
          <div className="flex items-center gap-2 mt-3">
            {showAcceptBtn && (
              <button
                ...
                className="px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 bg-orange-500 dark:bg-orange-600 text-white hover:bg-orange-600 dark:hover:bg-orange-700 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {acceptLoading && (
