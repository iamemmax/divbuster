...
import { cardProp, getGatewayDisplay } from '../MyCards';
...
interface Props {
  ...
  selectedCard: cardProp | undefined
}

const ViewCardDetails: React.FC<Props> = ({ isOpen, setIsOpenCardModal,selectedCard }) => {
  const {
    control,
    handleSubmit,
                    ...
                    <div className='border-y-[0.5px] py-3 border-opacity-55'>
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute right-4 top-1/2 -translate-y-1/2">
                         {getGatewayDisplay(selectedCard?.gateway as string)}
                        </div>
                      </div>
                      {errors.cardNumber && (
