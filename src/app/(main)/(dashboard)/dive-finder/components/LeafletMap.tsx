...
const LeafletMap = ({ diveSites }: LeafletMapProps) => {
    ...
    useEffect(() => {
        ...
        if (validSites.length > 0) {
            // Create custom marker icon using MapMarker SVG
...
<feBlend mode="normal" in="SourceGraphic" in2="effect2_dropShadow_26_732" result="shape"/>
            ...
            validSites.forEach(site => {
                ...
                // Create tooltip content with buttons
                const tooltipContent = `
                    <div style="padding: 12px; min-width: 200px; font-family: Arial, sans-serif;">
                        ...
                        <p style="margin: 0 0 12px 0; font-size: 12px; color: #6b7280;">${site.address}</p>
                        <p style="margin: 0 0 12px 0; font-size: 12px; color: #6b7280;">${site.description}</p>
                        <p style="margin: 0 0 12px 0; font-size: 12px; color: #6b7280;">lat:${site.lag} Log:${site?.lon}</p>
