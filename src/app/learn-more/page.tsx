  ...
  return (
    <main className='bg-[#080D27] text-white w-full h-full py-5 px-6 md:px-[120px]'>
        ...
        <div>
            ...
            <div>
            <span>  
            <p className='text-[42px] font-medium w-[642px] mt-1'>
            Liberty life - Health and Wealth for you.</p>
            <p className='text-[19px] font-normal text-[#CAC9D4] w-[499px]'>At Liberty life, we are committed at providing premium
            ...
            <div className='grid grid-cols-2 mt-8 gap-3'>
                <span className='bg-[#080D27] border-[0.3px] rounded-[10px]  px-6 py-6 border-[#407cff59]'>
                    <p className='flex gap-4 text-[38px] font-bold'>01<span className='text-[15px] font-medium py-4'>premium hospital</span></p>
                    <p className='text-[12px] font-normal w-[438px]'>Liberty life gives you premium hospitals with good healthcare facilities in your preferred state and local government.You can pick from the numerous hospitals around you.</p>
                </span>
                <span className='bg-[#080D27] border-[0.3px] rounded-[10px]  px-6 py-6 border-[#407cff59]'>
                    <p className='flex gap-4 text-[38px] font-bold'>02<span className='text-[15px] font-medium py-4'>Lifestyle Reward</span></p>
                    <p className='text-[12px] font-normal w-[438px]'>Liberty life gives you premium hospitals with good healthcare facilities in your preferred state and local government.You can pick from the numerous hospitals around you.</p>
                </span>
                <span className='bg-[#080D27] border-[0.3px] rounded-[10px]  px-6 py-6 border-[#407cff59]'>
                    <p className='flex gap-4 text-[38px] font-bold'>03<span className='text-[15px] font-medium py-4'>Premium Health Policy</span></p>
                    <p className='text-[12px] font-normal w-[438px] '>Liberty life gives you premium hospitals with good healthcare facilities in your preferred state and local government.You can pick from the numerous hospitals around you.</p>
                </span>
                <span className='bg-[#080D27] border-[0.3px] rounded-[10px]  px-6 py-6 border-[#407cff59]'>
                    <p className='flex gap-4 text-[38px] font-bold'>04<span  className='text-[15px] font-medium py-4'>Affordable Plan</span></p>
                    
                    <p className='text-[12px] font-normal w-[438px]'>Liberty life gives you premium hospitals with good healthcare facilities in your preferred state and local government.You can pick from the numerous hospitals around you.</p>
                </span>
            </div>
            <div className='flex bg-[#080D27]'>
                <p>
